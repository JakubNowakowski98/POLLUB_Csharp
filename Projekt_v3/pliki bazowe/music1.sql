...
('Just Can抰 Get Enough', 'The Black Eyed Peas', 'dance pop', 2011, 71),
...
('Atlas - From 揟he Hunger Games: Catching FireSoundtrack', 'Coldplay', 'permanent wave', 2013, 55),
...
('Boom Clap - From the Motion Picture Das Schicksal ist ein mieser Verr鋞er', 'Charli XCX', 'candy pop', 2014, 50),
...
('Wish That You Were Here - From 揗iss Peregrine抯 Home for Peculiar ChildrenOriginal Motion Picture', 'Florence + The Machine', 'art pop', 2016, 57),
...
('I Don抰 Wanna Live Forever (Fifty Shades Darker)', 'ZAYN', 'dance pop', 2017, 78),
...
('Reggaet髇 Lento (Remix)', 'CNCO', 'boy band', 2017, 71),
...
('Bon app閠it', 'Katy Perry', 'dance pop', 2017, 68),
